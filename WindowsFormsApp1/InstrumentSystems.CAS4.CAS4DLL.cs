...
namespace InstrumentSystems.CAS4
{
    ...
    public class CAS4DLL
    {
        ...
        public const int ErrorInterfaceVersion    = -20; ///< The firmware version of the interface card (PCI with CAS140 CTS) or the driver version is too old to work with this device.
        ...
        public static int casPerformActionEx(int ADevice, int AActionID, int AParam1, int AParam2, IntPtr AParam3) {
            return Environment.Is64BitProcess ? CAS4DLLx64.casPerformActionEx(ADevice, AActionID, AParam1, AParam2, AParam3) : CAS4DLLx86.casPerformActionEx(ADevice, AActionID, AParam1, AParam2, AParam3);
        }
        ...
        public const int mpidColormetricPeakDiffWidth = 67; ///<float: the width in nm that is used for differentiation when calculating the peak wavelength <see cref="casGetPeak"/>. If negative, a width of 7nm or at least 6 pixels are used - like in previous versions. Default value is -1. Applies to the current CAS ID and the currently active ParamSet only!
        ...
        /// </remarks>
        [Obsolete("method obsolete! Use paUpdateSpectralCalibration")]   
        ...
        /// <para>The integral is calculated from 380nm to 780nm for <see cref="cmtDefaultColormetric"/> or from 360nm to 830nm for <see cref="cmtSWPColormetric"/> unless further constrained using <see cref="mpidColormetricStart"/> and <see cref="mpidColormetricStop"/>. 
        ...
        /// <summary>
        /// Calculates dominant wavelength aka LambdaDom and purity from a given color coordinate and illuminant reference. This method is deprecated because it does not take the new <see cref="mpidColormetricType"/> into account. Use <see cref="casCalculateLambdaDom"/> instead.
        /// </summary>
        ...
        /// Purity is 0 if x = IllX and y = IllY. Purity will never exceed 1.
        ///    </remarks>
        public static int casCalculateLambdaDom(int ADevice, double IllX, double IllY, ref double LambdaDom, ref double Purity) {
            return Environment.Is64BitProcess ? CAS4DLLx64.casCalculateLambdaDom(ADevice, IllX, IllY, ref LambdaDom, ref Purity) : CAS4DLLx86.casCalculateLambdaDom(ADevice, IllX, IllY, ref LambdaDom, ref Purity);
        }
        ...
        ///    </remarks>
        [Obsolete("method obsolete! Use mpidCurrentCCDTemperature")]
